...
class Ui_PatracDockWidget(object):
    def setupUi(self, PatracDockWidget):
        ...
        self.tbtnShowMessage.setIconSize(QSize(24, 24))
        self.tbtnShowMessage.setFixedSize(QSize(32, 32))
        ...
        self.showHandlers.setIconSize(QSize(24, 24))
        self.showHandlers.setFixedSize(QSize(32, 32))
        ...
        self.tbtnInsertFinal.setIconSize(QSize(24, 24))
        self.tbtnInsertFinal.setFixedSize(QSize(32, 32))
        ...
        self.tbtnShowSettings.setIconSize(QSize(24, 24))
        self.tbtnShowSettings.setFixedSize(QSize(32, 32))
        ...
        self.helpShow.setIconSize(QSize(24, 24))
        self.helpShow.setFixedSize(QSize(32, 32))
    ...
    def setGuideSteps(self):
        ...
        self.tabGuideSteps.addTab(self.tabGuideStep6, "5")
