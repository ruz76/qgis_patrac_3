...
<qgis version="2.18.17" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="stav" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="0" label="Nezahájeno"/>
      <category render="true" symbol="1" value="1" label="Zahájeno"/>
      <category render="true" symbol="2" value="2" label="Dokončeno"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;stav&quot;" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="cat"/>
      <column width="-1" hidden="0" type="field" name="id"/>
      <column width="-1" hidden="0" type="field" name="typ"/>
      <column width="-1" hidden="0" type="field" name="stav"/>
      <column width="-1" hidden="0" type="field" name="prostredky"/>
