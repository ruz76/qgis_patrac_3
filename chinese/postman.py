...
if __name__ == '__main__':
    ...
    parser.add_argument("--start_node", help="input file with starting node ID", type=argparse.FileType('r'))
    ...
    start_node_id = args.start_node.read().strip()
    print("START NODE ID: " + str(start_node_id))
    paths = chinese_postman_paths(component, n=5, start_node=start_node_id)
